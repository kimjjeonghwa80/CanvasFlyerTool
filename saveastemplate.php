<?php
	...
	$insert_Qry = "INSERT INTO template (template_id, template_name, canvas_thumbnail, canvas_json) VALUES ('', '".$_POST['filename']."', '', '')";
	...
	$update_Qry = "UPDATE template set canvas_thumbnail = 'templates/". $last_template_id . ".png', canvas_json = 'templates/". $last_template_id . ".ype' WHERE template_id = " . $last_template_id;
